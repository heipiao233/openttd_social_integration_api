...
use crate::raw_api::{
    OpenTTD_SocialIntegration_v1_InitResult,
    OpenTTD_SocialIntegration_v1_InitResult_OTTD_SOCIAL_INTEGRATION_V1_INIT_FAILED,
    OpenTTD_SocialIntegration_v1_InitResult_OTTD_SOCIAL_INTEGRATION_V1_INIT_PLATFORM_NOT_RUNNING,
...
impl From<OpenTTD_SocialIntegration_v1_OpenTTDInfo> for OpenTTDInfo {
    fn from(value: OpenTTD_SocialIntegration_v1_OpenTTDInfo) -> Self {
        OpenTTDInfo {
            openttd_version: unsafe {
                CStr::from_ptr(value.openttd_version)
                    .to_string_lossy()
                    .into_owned()
            },
        }
...
pub unsafe fn call_init<F>(
    ...
    Option<OpenTTD_SocialIntegration_v1_PluginApi>,
    OpenTTD_SocialIntegration_v1_InitResult,
)
where
    F: FnOnce(OpenTTDInfo) -> Result<Option<PluginApi>, ()>,
{
